...
import 'package:hey_visitas/src/pages/visits_pending/visits_pending_controller.dart';

import '../../util/menu.dart';
import '../../util/my_colors.dart';

class VisitsPendingPage extends StatefulWidget {
  const VisitsPendingPage({Key? key}) : super(key: key);

  @override
  State<VisitsPendingPage> createState() => _VisitsPendingPageState();
}

class _VisitsPendingPageState extends State<VisitsPendingPage> {

  late List list_product ;
  List<Menu> data = [];
  VisitsPendingController _con = VisitsPendingController();
                            ...
                            Positioned(
                              ...
                              Container(
                                ...
                                child:  ElevatedButton(
                                  ...
                                  child: const Text("Avisos Pendientes",
                                      style: TextStyle(
                                          color: Colors.white,
